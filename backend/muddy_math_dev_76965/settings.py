"""
Django settings for muddy_math_dev_76965 project.
...
ROOT_URLCONF = 'muddy_math_dev_76965.urls'
...
WSGI_APPLICATION = 'muddy_math_dev_76965.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "muddy_math_dev_76965 API",
    "DESCRIPTION": "API documentation for muddy_math_dev_76965 App",
    "VERSION": "v1",
}
